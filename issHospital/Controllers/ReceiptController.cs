...
namespace issHospital.Controllers
{
    public class ReceiptController : Controller
    {
       public Receipt objModel = new Receipt();
        ...
        public ActionResult Create([Bind(Include = "Id,SlNo,Amount,Age,Name,Doctor,Purpose,dept,sex,Type,BP,weight,Temp,FName,UserName,Date,Billtime,isDeleted,deletedBy,deletedOn,updatedBy,UpdatedOn,UHID")] TblReceipts Receipt)
        {
            try
            {
